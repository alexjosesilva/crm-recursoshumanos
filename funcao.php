                ...
                <div class="padding">
                    <div class="full col-sm-9">
                        ...
                        <div class="col-sm-5" id="featured">   
                          ...
                          <form class="form-horizontal" action="inserir_funcao.php" method="post">
							<fieldset>
							
							<!-- Form Name -->
							<legend>Incluir Função</legend>
							
							<!-- Text input-->
							<div class="control-group">
							  <label class="control-label" for="filme">Nome da Função</label>
							  <div class="controls">
							    <input id="descricaoFuncao" name="descricaoFuncao" type="text" placeholder="Nome da Função" />
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							    <textarea id="codigoFuncao" name="codigoFuncao" placeholder="codigo Funcao"></textarea>
							  </div>
							</div>
                        ...
                        <table class="table table-hover">
                        	...
                        	?>
	                        	<tr>
	                        		<td class="col-md-1"><a class="btn btn-default" href="alterar_funcao.php?codigo=<?$linha['codigoFuncao']?>" role="button">Alterar</a></td>
