                        ...
                        <div class="col-sm-5" id="featured">   
                          ...
                          <form class="form-horizontal" action="inserir_funcionario.php" method="post">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							    <input id="nomeFuncionario" name="nomeFuncionario" type="text" placeholder="Nome do funcionários" class="input-xxlarge" />
							...
							<!-- Text input-->
							<div class="control-group">
							  <label class="control-label" for="trailer">Matricula Funcionario</label>
							  <div class="controls">
							    <input id="codigoFuncionario" name="codigoFuncionario" type="text" placeholder="codigo Funcionario">
							  </div>
							</div>
							...
							<div >
							  <label  for="dataNascimento">Data de nascimento</label>
							   ...
							   <p> <input id="dataNascimento" name="dataNascimento" type="text"> </p>
